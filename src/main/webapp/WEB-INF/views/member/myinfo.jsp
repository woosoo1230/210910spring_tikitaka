...
<main class="form-signin">
	...
	<div class="container">
		<form action="/semiproject/updateInfo" method="post">
			<table class="table table-hover">
			  ...
			  <tbody>
			    <tr>
			      ...
			      <input type="text" class="form-control" id="mid" name="mid" value="${vo.mid}" disabled="disabled"></td>
			    </tr>
			    <tr>
			      <th scope="row">이름</th>
			      <td colspan="2"><input type="text" class="form-control" id="mname" name="mname" value="${vo.mname }" disabled="disabled"></td>
			    </tr>
			    <tr>
			      <th scope="row">닉네임</th>
			      <td><input type="text" class="form-control" id="nickname" name="nickname" value="${vo.nickname }"></td>
			      <td>
